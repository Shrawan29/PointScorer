        ...
        >
          ...
          <div className="grid gap-2">
            {rules.map((rule, idx) => {
              ...
              return (
                <div key={ev} className={`border border-slate-200 rounded-md p-3 ${enabled ? 'bg-white' : 'bg-slate-50'}`}>
                    ...
                    <div className="grid grid-cols-2 sm:flex sm:items-end gap-2 sm:gap-3">
                      <label className="block">
                        ...
                        <input
                          ...
                          className="w-full sm:w-28 px-3 py-2.5 border rounded-md bg-white disabled:bg-slate-100 focus:outline-none focus:ring-1 focus:ring-slate-300"
                        />
                      </label>

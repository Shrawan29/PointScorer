...
export const LiveFriendsPage = () => {
  ...
  const load = useCallback(async ({ silent = false } = {}) => {
    ...
    try {
      ...
      setError(err?.response?.data?.message || 'Failed to load live friends');
    } finally {
  ...
  return (
    <Layout>
      <PageHeader
        ...
        subtitle={`Only linked users appear here. Realtime: ${liveRealtimeConnected ? 'connected' : 'fallback polling'}.`}
        actions={
